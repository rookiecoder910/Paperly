...
export default function SignupPage() {
    ...
    return (
        <div className="animated-orbs flex min-h-screen flex-col">
            {/* Extra orb */}
            <div className="animated-orbs-extra" />
            ...
            <nav className="relative z-10 flex items-center gap-2 px-6 py-4">
                <Link href="/" className="flex items-center gap-2 group">
                    ...
                    <span className="text-lg font-bold text-white">Paperly</span>
                </Link>
            </nav>
            ...
            <div className="relative z-10 flex flex-1 items-center justify-center px-4">
                <div className="glass-card-glow w-full max-w-md px-8 py-10 sm:px-10 sm:py-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <Input
                            ...
                            required
                            className="h-12 border-white/10 bg-white/[0.06] text-white placeholder:text-slate-400 focus:border-cyan-400/40 focus:ring-cyan-400/20"
                        />
                    ...
                    <button
                        type="button"
                        className="flex w-full items-center justify-center gap-3 rounded-lg border border-white/10 bg-white/[0.04] px-4 py-3 text-sm text-slate-300 transition-colors hover:bg-white/[0.08]"
                    >
